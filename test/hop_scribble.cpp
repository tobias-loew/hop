...
namespace ns_test_16 {
    ...
    public:
        ...
        template<typename... Ts, hop::enable_t<overloads, Ts...>* = nullptr >
        void foo(Ts&& ... ts) {
    ...
    public:
        ...
        template<typename... Ts, hop::enable_t<ext_overloads, Ts...>* = nullptr >
        void foo(Ts&& ... ts) {
            using OL = hop::enable_t<ext_overloads, Ts...>;
...
namespace ns_test_17 {
    ...
    public:
        ...
        foo_class(Ts&& ... ts)
            ...
            : foo_class(hop::get_tag_type<hop::enable_t<overloads_t, Ts...>>{}, std::forward<Ts>(ts)...) {
            using OL = hop::enable_t<overloads_t, Ts...>;
